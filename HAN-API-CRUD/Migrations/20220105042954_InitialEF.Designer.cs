...
namespace HAN_API_CRUD.Migrations
{
    ...
    [Migration("20220105042954_InitialEF")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HAN_API_CRUD.Data.ActivePowerAQ1Q4Object", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<double>("ActivePowerAQ1Q4")
                        .HasColumnType("float");
                    ...
                    b.ToTable("ActivePowerAQ1Q4");
                });

            modelBuilder.Entity("HAN_API_CRUD.Data.ActivePowerAQ2Q3Object", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<double>("ActivePowerAQ2Q3")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("HAN_API_CRUD.Data.List1", b =>
                {
            ...
            modelBuilder.Entity("HAN_API_CRUD.Data.List2", b =>
                {
                    b.Property<Guid>("HANDataId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HAN_API_CRUD.Data.List3", b =>
                {
                    b.Property<Guid>("HANDataId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("ActivePowerAQ1Q4Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("ActivePowerAQ2Q3Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ReactivePowerRQ1Q2Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("ReactivePowerRQ3Q4Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ActivePowerAQ1Q4Id");

                    b.HasIndex("ActivePowerAQ2Q3Id");
                    ...
                    b.HasIndex("ReactivePowerRQ1Q2Id");

                    b.HasIndex("ReactivePowerRQ3Q4Id");
            ...
            modelBuilder.Entity("HAN_API_CRUD.Data.ReactivePowerRQ1Q2Object", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<double>("ReactivePowerRQ1Q2")
                        .HasColumnType("float");
                    ...
                    b.ToTable("ReactivePowerRQ2Q3");
                });

            modelBuilder.Entity("HAN_API_CRUD.Data.ReactivePowerRQ3Q4Object", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<double>("ReactivePowerRQ3Q4")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("HAN_API_CRUD.Data.List3", b =>
                {
                    b.HasOne("HAN_API_CRUD.Data.ActivePowerAQ1Q4Object", "ActivePowerAQ1Q4")
                        .WithMany()
                        .HasForeignKey("ActivePowerAQ1Q4Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HAN_API_CRUD.Data.ActivePowerAQ2Q3Object", "ActivePowerAQ2Q3")
                        .WithMany()
                        .HasForeignKey("ActivePowerAQ2Q3Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("HAN_API_CRUD.Data.ReactivePowerRQ1Q2Object", "ReactivePowerRQ1Q2")
                        .WithMany()
                        .HasForeignKey("ReactivePowerRQ1Q2Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HAN_API_CRUD.Data.ReactivePowerRQ3Q4Object", "ReactivePowerRQ3Q4")
                        .WithMany()
                        .HasForeignKey("ReactivePowerRQ3Q4Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("ActivePowerAQ1Q4");

                    b.Navigation("ActivePowerAQ2Q3");
                    ...
                    b.Navigation("ReactivePowerRQ1Q2");

                    b.Navigation("ReactivePowerRQ3Q4");
